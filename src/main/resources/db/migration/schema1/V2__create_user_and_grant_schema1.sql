...
BEGIN
    ...
    IF v_count_users > 0 THEN
        --EXECUTE IMMEDIATE 'DROP USER user_schema1 CASCADE';
    ...
    IF v_count_roles < 1 THEN
        ...
        EXECUTE IMMEDIATE 'GRANT SELECT, INSERT, UPDATE, DELETE ON SCHEMA_1."USER" TO user_schema1';
        EXECUTE IMMEDIATE 'GRANT SELECT, INSERT, UPDATE, DELETE ON SCHEMA_1.CAR TO user_schema1';
        EXECUTE IMMEDIATE 'GRANT ALTER ON SCHEMA_1."USER" TO user_schema1';
        ...
        EXECUTE IMMEDIATE 'GRANT ALL PRIVILEGES ON SCHEMA_1."USER" TO user_schema1';
